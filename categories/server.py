...
def save_presentation():
    try:
        ...
        for slide_data in slides[num_existing_slides:]:
            ...
            if layout_type == 'boxes':
                ...
                create_versus_layout(slide, content)
            elif layout_type == 'brain':
                create_brain_layout(slide, content)
            else:
                create_list_boxes(slide, content)
...
def create_versus_layout(slide, content):
...
def create_brain_layout(slide, content):
